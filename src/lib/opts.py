...
class opts(object):
  def __init__(self):
    ...
    # ---------------------------------------------------------------------------------
    self.parser.add_argument('--strength_sampling_threshold', type=float, default=1.0, 
                             help='visualization threshold. default:1.0, use all raw images') 
    
    # GS:
    self.parser.add_argument('--gs_group_num', type=int,
                             help='gs_groupnum')    
    self.parser.add_argument('--gs_label2binlabel', default='',
                             help='path to label2binlabel pt model')
    self.parser.add_argument('--gs_pred_slice', default='',
                             help='path to pred_slice pt model') 
    self.parser.add_argument('--gs_id_newid', default='',
                             help='path to id_newid.txt') 
    
    # track
    self.parser.add_argument('--exp_name', type=str, default=None, help='experiment name')

    self.parser.add_argument('--output_dir', type=str, default='/mnt/A/hust_chensijia/Trajectory-Long-tail-Distribution-for-MOT/Inference_results', help='where to save the inference results')

    self.parser.add_argument('--benchmark_name', type=str, default=None, help='None or key in yaml, None=COMMOM_HYPES')

    self.parser.add_argument('--frame_rate', type=int, default=30, help='None or key in yaml, None=COMMOM_HYPES')

    # vis
    self.parser.add_argument('--save_videos', action="store_true", help='save video or not')
    self.parser.add_argument('--vis_state', action="store_true", help='vis feature during tracking')
    self.parser.add_argument('--vis', action="store_true", help='vis feature during tracking')
    ...
    # all_classes ; head_classes ; tail_classes
    self.parser.add_argument('--gt_txt', type=str, default='gt.txt', help='gt classes')

    # mot
    self.parser.add_argument('--data_cfg', type=str,
                             default='../src/lib/cfg/data.json',
                             help='load data from cfg')
    self.parser.add_argument('--data_dir', type=str, default='/mnt/A/hust_chensijia/FairMOT/dataset/')
    ...
    self.parser.add_argument('--id_loss', default='ce', # default: ce loss
                             help='reid loss: ce | focal | gs') 
  ...
  def parse(self, args=''):
    ...
    # opt.root_dir = "/mnt/D/chensijia/FairMOT" # Manual setting
