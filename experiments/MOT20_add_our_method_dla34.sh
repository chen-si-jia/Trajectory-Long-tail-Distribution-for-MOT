...
CUDA_VISIBLE_DEVICES=0 python train.py mot --load_model '../models/ctdet_coco_dla_2x.pth' \
                            --exp_id mot20_add_our_method_correction_dla34/mot20_add_our_method_correction_visualThreshold_1.0/strength_sampling_threshold_1.0_gs_2 \
